...
const DoctorsCard = ({ doctor }) => {
  ...
  return (
    <div className="p-3 lg:p-5 transition-all duration-300 ease-in-out transform hover:scale-105 hover:shadow-lg rounded-lg">
      <div className="overflow-hidden rounded-lg">
        <img
          src={photo}
          className="w-full object-cover rounded-lg transition-all duration-300 hover:scale-110"
          alt={name}
        />
      </div>
      ...
      <h2
        ...
        font-[700] mt-3 lg:mt-5 transition-all duration-300"
      >
        {name}
      </h2>
