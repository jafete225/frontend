          ...
          <div className="grid lg:grid-cols-3 gap-[30px] lg:gap-[50px]">
            ...
            <div className="lg:col-span-2">
              {data?.isApproved === "pending" && (
                <div className="flex p-4 mb-4 text-yellow-800 bg-yellow-50 rounded-lg">
                  ...
                  <div className="ml-3 text-sm font-medium">
                    Para obter aprovação, preencha o seu perfil. Revisaremos
                    manualmente e aprovaremos dentro de 3 dias.
                  </div>
                </div>
              )}
              ...
              <div className="mt-8">
                  ...
                  <div>
                    <div className="flex items-center gap-4 mb-10">
                      <figure className="max-w-[200px] max-h-[200px]">
                        <img
                          src={data?.photo || "/path/to/default/photo.jpg"}
                          alt="Profile"
                          className="w-full"
                        />
                      </figure>
                      ...
                      <div>
                        ...
                        >
                          {data?.specialization || "Sem especialiazação"}
                        </span>
                    ...
                    <DoctorAbout
                      ...
                      about={data?.about || "Sem informação"}
                ...
                {!["overview", "appointments", "settings"].includes(tab) && (
